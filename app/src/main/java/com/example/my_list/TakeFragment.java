...
public class TakeFragment extends Fragment {
    ...
    private SQLiteDatabase mDBT;
    private DBHelperT mdbHelperT;
    ...
    public static TakeFragment newInstance(String param1, String param2, String param3, String param4, int param5, int param6) {
    ...
    private void loadTable() {
        mDBT = mdbHelperT.getReadableDatabase();
        mListData.clear();

        Cursor cursor = mDBT.rawQuery(DBContractT.SQL_LOAD, null);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mSAdapter = new SimpleAdapter(getActivity(), mListData, android.R.layout.simple_list_item_checked, new String[]{"name"}, new int[]{android.R.id.text1});
        mListView = view.findViewById(R.id.listView);
        mListView.setAdapter(mSAdapter);
        mdbHelperT = new DBHelperT(getActivity());
        loadTable();
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, final int i, long l) {
                ...
                Snackbar.make(view, item.get("name") + "항목을 삭제 하시겠습니까?", Snackbar.LENGTH_LONG)
                        .setAction("삭제", new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {

                                mListData.remove(i);
                                mDBT.delete(DBContractT.TABLE_NAME, "id=" + mISelectedID, null);
                                mSAdapter.notifyDataSetChanged();
        ...
        btnCG.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                NavHostFragment.findNavController(TakeFragment.this).navigate(R.id.action_takeFragment_to_takeOneFragment);
            }
        });
        ...
        fadAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                bundle.putInt("id", 0);
                NavHostFragment.findNavController(TakeFragment.this).navigate(R.id.action_takeFragment_to_takeEditeFragment, bundle);
        ...
        if (mParam1 != null) {
            ...
            values.put(DBContractT.COL_NAME, mParam1);
            ...
            mDBT = mdbHelperT.getWritableDatabase();//조회가 아닌 인서트하고 없데이트 할수있는 메소드
            if (item == -1) {/*만약 아이템값이 -1 이면 추가하는경우*/
                values.put(DBContractT.COL_ID, ++/*가장큰값보다 하나더증가시켜 저장*/mID);
                hitem.put("id", String.valueOf(mID));
                mDBT.insert(DBContractT.TABLE_NAME, null, values);
                mListData.add(hitem);
                Toast.makeText(getActivity(), "추가", Toast.LENGTH_LONG).show();
            } else {
                hitem.put("id", String.valueOf(mISelectedID));

                mDBT.update(DBContractT.TABLE_NAME, values, "id=" + mISelectedID, null);
