...
interface DBContract {
    ...
    static final String COL_NAMES="NAMES";
    static final String COL_ST="ST";
    static final String COL_AMT="AMT";
    static final String COL_DAY="DAY";
    static final String COL_NAMET="NAMET";
    static final String COL_NAMETO="NAMETO";
